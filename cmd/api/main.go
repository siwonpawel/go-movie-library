...
import (
	...
	"github.com/siwonpawel/greenlight/internal/jsonlog"
	"github.com/siwonpawel/greenlight/internal/mailer"
)
...
func main() {
	...
	flag.IntVar(&cfg.db.maxOpenConns, "db-max-open-conns", 4, "PostgreSQL max open connections")
	flag.IntVar(&cfg.db.maxIdleConns, "db-max-idle-conns", 4, "PostgreSQL max idle connections")
